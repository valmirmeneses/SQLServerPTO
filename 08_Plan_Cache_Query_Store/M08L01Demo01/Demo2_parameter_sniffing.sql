...
/*
	The first query returns only 2 rows.  The second returns 1552 rows.
	...
	higher at 4672 logical reads.  More I/O = slower performance.
	
		Table 'Person'. Scan count 1, logical reads 9
		Table 'Person'. Scan count 1, logical reads 4672
...
/*
	...
	many individual index seeks.  The proof is in the I/O statistics:
		...
		Table 'Person'. Scan count 1, logical reads 3822
		Table 'Person'. Scan count 1, logical reads 3822

	The cost for the "M" execution was 3822 logical reads - still high, but 
	better than the 4672 logical reads incurred using Nested Lookups.  

	The cost for the "Q" execution, on the other hand, is *much* higher than it
	was before - 3822 vs 9 logical reads.  Clearly, this is a less cost-effective 
